...
\addtolength{\footskip}{-1cm} %Seitenzahlen ein bisschen höher setzen
...
\setstretch{1.54} %Simuliert den 1,5 fachen Zeilenabstand von Word (Bei dieser Schriftart und dieser Schriftgröße)
...
\usepackage{titlesec} %Dieser Abschnitt definiert die Überschriften
...
%\setkomafont{pagefoot}{\normalfont} %Sonst wird Fußzeile kursiv
...
\usepackage[latin1]{inputenc} % latin1-Kodierung für Umlaute
% \usepackage[ngerman]{babel}  % Silbentrennung
\usepackage[T1]{fontenc}
\usepackage[scaled]{uarial} % Schriftart Arial
\usepackage[font=small,labelfont=it]{caption} %Überschriften kursiv
